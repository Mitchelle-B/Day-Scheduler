...
function setUpTimeBlocks(){
    $(".time-block").each(function(){
      ...
      if (thisBlockHr == currentHour) {
        $(".time-block").addClass("present").removeClass("past future");
      }
      if (thisBlockHr < currentHour) {
        $(".time-block").addClass("past").removeClass("present future");
      }
      if (thisBlockHr > currentHour) {
        $(".time-block").addClass("future").removeClass("past present");
      }
    });
}
